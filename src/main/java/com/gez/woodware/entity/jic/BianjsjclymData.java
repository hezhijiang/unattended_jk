...
@Data
@ApiModel(description = "编辑司机车辆页面返回对象类")
@JsonSerialize(include= JsonSerialize.Inclusion.NON_NULL)
public class BianjsjclymData {
   ...
   @ApiModelProperty("状态 编码")
	private List<CodeValue> stageCode;
	...
	public String getStage() {
      if ((stage==null || stage=="") && stageCode!=null){
          stage  = stageCode.get(0).getCode();
      }
		return stage;
	}
